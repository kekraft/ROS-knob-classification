...
def pointcloud2_to_array(msg):
    ...
    if not fmt_full:
        X = 'x' * 12
        fmt =  '<fffxxxxBBBx' + X #_get_struct_fmt(msg)  #  we changed to get r g b values and ignore a Austin N and Kory Kraft 11/21/2014
        print 'Fmt stirng: ', fmt
        fmt_full = '>' if msg.is_bigendian else '<' + fmt.strip('<>')*msg.width*msg.height
    # import pdb; pdb.set_trace()    
    #print 'Format string', fmt_full
